...
public class BirthdayCommand extends Command {
    ...
    public CommandResult execute(Model model) throws CommandException {
        ...
        Person editedPerson = new Person(
                ...
                personToEdit.getInstrument(), personToEdit.getTags(), personToEdit.getAttendances());
    ...
    private String generateSuccessMessage(Person personToEdit) {
        String message = !birthday.value.equals(DEFAULT_BIRTHDAY)
                ? MESSAGE_ADD_BIRTHDAY_SUCCESS : MESSAGE_DELETE_BIRTHDAY_SUCCESS;
