...
public class JsonAdaptedPersonTest {
    ...
    public void toModelType_nullName_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(null, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                VALID_MATRICULATIONYEAR, VALID_BIRTHDAY, VALID_TAGS, VALID_ATTENDANCES);
    ...
    public void toModelType_nullBirthday_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                null, VALID_MATRICULATIONYEAR, VALID_TAGS, VALID_ATTENDANCES);
    ...
    public void toModelType_invalidTags_throwsIllegalValueException() {
        ...
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS, VALID_BIRTHDAY,
                        VALID_MATRICULATIONYEAR, invalidTags, VALID_ATTENDANCES);
    ...
    public void toModelType_invalidAttendances_throwsIllegalValueException() {
        ...
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS, VALID_BIRTHDAY,
                        VALID_MATRICULATIONYEAR, VALID_TAGS, invalidAttendances);
        assertThrows(IllegalValueException.class, person::toModelType);
    }
}
