...
public class JsonAdaptedPersonTest {
    ...
    private static final String INVALID_MATRICULATIONYEAR = "3000";
    ...
    private static final String VALID_MATRICULATIONYEAR = BENSON.getMatriculationYear().toString();
    ...
    public void toModelType_invalidName_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(INVALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS, VALID_BIRTHDAY,
                        VALID_MATRICULATIONYEAR, VALID_INSTRUMENT, VALID_TAGS, VALID_ATTENDANCES);
    ...
    public void toModelType_nullName_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(null, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                VALID_MATRICULATIONYEAR, VALID_INSTRUMENT, VALID_BIRTHDAY, VALID_TAGS, VALID_ATTENDANCES);
    ...
    //                        VALID_MATRICULATIONYEAR, VALID_TAGS, VALID_ATTENDANCES);
    //        String expectedMessage = Address.MESSAGE_CONSTRAINTS;
    //        assertThrows(IllegalValueException.class, expectedMessage, person::toModelType);
    //    }
    ...
    public void toModelType_nullBirthday_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                null, VALID_MATRICULATIONYEAR, VALID_INSTRUMENT, VALID_TAGS, VALID_ATTENDANCES);
    ...
    //                        INVALID_MATRICULATIONYEAR, VALID_TAGS, VALID_ATTENDANCES);
    //        String expectedMessage = Address.MESSAGE_CONSTRAINTS;
    //        assertThrows(IllegalValueException.class, expectedMessage, person::toModelType);
    //    }
    ...
    public void toModelType_invalidInstrument_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS, VALID_BIRTHDAY,
                        VALID_MATRICULATIONYEAR, INVALID_INSTRUMENT, VALID_TAGS, VALID_ATTENDANCES);
    ...
    public void toModelType_invalidTags_throwsIllegalValueException() {
        ...
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS, VALID_BIRTHDAY,
                        VALID_MATRICULATIONYEAR, VALID_INSTRUMENT, invalidTags, VALID_ATTENDANCES);
    ...
    public void toModelType_invalidAttendances_throwsIllegalValueException() {
        ...
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS, VALID_BIRTHDAY,
                        VALID_MATRICULATIONYEAR, VALID_INSTRUMENT, VALID_TAGS, invalidAttendances);
        assertThrows(IllegalValueException.class, person::toModelType);
    }
}
